...
export function CreateCertificateClient({ bootcamps }: { bootcamps: Bootcamp[] }) {
    ...
    const [showInstructorSignature, setShowInstructorSignature] = useState(true);
    const [showDirectorSignature, setShowDirectorSignature] = useState(true);
                    ...
                    <div className="px-6 h-full border-b border-border">
                        <div className="flex items-center justify-between h-full">
                            <div className="flex items-center gap-4">
                                ...
                                <h2 className="text-sm font-light text-foreground">Crear Certificado</h2>
                            </div>
                            <button
